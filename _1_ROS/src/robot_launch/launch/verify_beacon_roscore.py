...
#To enable a competition_start.launch some conditions are necessary
# | | | |
# v v v v
...
#3rd : Set Ros env variable to enable same roscore comunication
...
print(f"Log [{FILE_NAME}]: Connecté au Louise roscore.")
exit(0)